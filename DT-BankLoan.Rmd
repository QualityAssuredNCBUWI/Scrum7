...
```{r}
set.seed(21)
newDataset <-sample.split(Y=data$X, SplitRatio = 0.7)
...
DTmodel <- rpart(won ~ age + job + education , method="class", data=trainData, parms = list (split ="information gain"), control = rpart.control(minsplit = 100, maxdepth = 10))  
```
