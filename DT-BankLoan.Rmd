...
set.seed(321)
newDataset_lead_1 <-sample.split(Y=data_lead_1$lead, SplitRatio = 0.25)
newDataset_lead_0 <-sample.split(Y=data_lead_0$lead, SplitRatio = 0.5)

trainData <-rbind(data_lead_1[newDataset_lead_1,], data_lead_0[newDataset_lead_0,])
testData <- rbind(data_lead_1[!newDataset_lead_1,][1:180,], data_lead_0[!newDataset_lead_0,])
